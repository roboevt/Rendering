...
public class Camera {
	...
	public Ray[][] generateRaysQuadrant(int quadrant){
		if(quadrant==1) {
			return generateRaysPortion(renderWidth/2,renderWidth,renderHeight/2,renderHeight,1);
		}
		if(quadrant==2) {
			return generateRaysPortion(0,renderWidth/2,renderHeight/2,renderHeight,2);
		}
		if(quadrant==3) {
			return generateRaysPortion(0,renderWidth/2,0,renderHeight/2,3);
		}
		if(quadrant==4) {
			return generateRaysPortion(renderWidth/2,renderWidth,0,renderHeight/2,4);
		}
		return null;
	}
